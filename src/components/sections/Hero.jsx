  ...
  return (
    <div>
      <div id='container' className='py-[15vh] flex flex-col align-middle small:py-[20vh]'>
        <div className='absolute  top-[45vmax]  z-10 w-[3vmax] left-[10vmax] small:left-[5vmax]  small:top-[55vmax] bounce'>
        ...
        <div id='upper-half-container' className='flex flex-col w-full items-center -z-10'>
          ...
          <div id='animation-gif' className='w-[35%] small:w-[90%] mt-[-5vmax] mb-[-6vmax] small:-mt-[5vmax] small:-mb-[10vmax]'>
